...
function ImageIcon({ source, color }: { source: ImageSourcePropType; color: string }) {
  return (
    <Image
      source={source}
      style={{
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Search',
          tabBarIcon: ({ color }) => <ImageIcon source={searchIcon} color={color} />,
        }}
      />
      <Tabs.Screen
        name="shop"
        options={{
          title: 'Shop',
          tabBarIcon: ({ color }) => <ImageIcon source={ShopIcon} color={color} />,
        }}
      />
      <Tabs.Screen
        name="favorites"
